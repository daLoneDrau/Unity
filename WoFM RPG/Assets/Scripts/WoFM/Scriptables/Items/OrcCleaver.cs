...
{
    public class OrcCleaver : WeaponBase
    {
        ...
        {
            WoFMInteractiveObject playerIO =
                ((WoFMInteractive)Interactive.Instance).GetPlayerIO();
            WoFMInteractiveObject itemIO = (WoFMInteractiveObject)
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Orc Cleaver";
            Io.ItemData.Description = "A wicked Orc cleaver.";
        ...
        public override int OnInventoryUse()
        {
            ...
            if (fighting == 0)
            {
                ...
                Io.ItemData.Equip(((WoFMInteractive)Interactive.Instance).GetPlayerIO());
            }
