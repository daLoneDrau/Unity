...
SET DllContainingTests=%~dp0RPGTests\bin\Debug\RPGTests.dll
...
SET TestRunnerExe=%PROGRAMFILES(X86)%\Microsoft Visual Studio\2017\Community\Common7\IDE\MSTest.exe
...
"%OpenCoverExe%" ^
 ...
 -filter:"+[RPGBase*]* -[*.Tests*]* -[*]*.Global -[*]*.RouteConfig -[*]*.WebApiConfig" ^
 -mergebyhash ^
 -skipautoprops ^
 -register:user ^
