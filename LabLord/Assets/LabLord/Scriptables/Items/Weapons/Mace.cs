...
namespace LabLord.Scriptables.Items.Weapons
{
    public class Mace : WeaponBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Mace";
            SetLocalVariable("shop_listing", "Mace");
            Io.ItemData.Description = "A weapon with a heavy head on a solid shaft used to bludgeon opponents.";
