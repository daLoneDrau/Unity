...
{
    public class Morningstar : WeaponBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Morningstar";
            SetLocalVariable("shop_listing", "Morningstar");
            Io.ItemData.Description = "A spiked mace.";
