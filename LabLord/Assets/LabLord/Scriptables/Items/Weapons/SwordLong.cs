...
{
    public class SwordLong : WeaponBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Longsword";
            SetLocalVariable("shop_listing", "Sword, long");
            Io.ItemData.Description = "A straight, double-edged weapon with a single-handed hilt.";
