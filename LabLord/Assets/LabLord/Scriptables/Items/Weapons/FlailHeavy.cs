...
{
    public class FlailHeavy : WeaponBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Heavy Flail";
            SetLocalVariable("shop_listing", "Flail, heavy");
            Io.ItemData.Description = "A long, two-handed infantry weapon with a cylindrical head.";
