...
{
    public class SwordShort : WeaponBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Shortsword";
            SetLocalVariable("shop_listing", "Sword, short");
            Io.ItemData.Description = "A long knife with a blade between 1 and 2 feet.";
