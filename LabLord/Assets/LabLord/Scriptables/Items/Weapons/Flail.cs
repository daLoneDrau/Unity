...
namespace LabLord.Scriptables.Items.Weapons
{
    public class Flail : WeaponBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Flail";
            SetLocalVariable("shop_listing", "Flail");
            Io.ItemData.Description = "A hand weapon derived from the agricultural tool.";
