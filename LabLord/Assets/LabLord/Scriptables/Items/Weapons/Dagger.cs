...
namespace LabLord.Scriptables.Items.Weapons
{
    public class Dagger : WeaponBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Dagger";
            SetLocalVariable("shop_listing", "Dagger");
            Io.ItemData.Description = "A knife specifically designed for combat.";
            ...
            */
            // 3gp
            Io.ItemData.Price = 300f;

            Io.ItemData.StackSize = 1;
            Io.ItemData.Title = "Dagger";
