...
namespace LabLord.Scriptables.Items.Weapons
{
    public class Lance : WeaponBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Lance";
            SetLocalVariable("shop_listing", "Lance");
            Io.ItemData.Description = "A pole weapon designed to be used by a mounted warrior or cavalry soldier.";
