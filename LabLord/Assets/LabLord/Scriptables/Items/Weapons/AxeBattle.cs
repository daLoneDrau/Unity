...
{
    public class AxeBattle : WeaponBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Battle Axe";
            SetLocalVariable("shop_listing", "Axe, battle");
            Io.ItemData.Description = "An axe specifically designed for combat.";
