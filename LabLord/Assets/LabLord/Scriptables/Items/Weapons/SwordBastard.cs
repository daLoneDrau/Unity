...
{
    public class SwordBastard : WeaponBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Bastard sword";
            SetLocalVariable("shop_listing", "Sword, bastard");
            Io.ItemData.Description = "A large sword designed to be used with one or both hands.";
