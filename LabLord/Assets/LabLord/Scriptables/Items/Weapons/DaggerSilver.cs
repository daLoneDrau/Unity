...
{
    public class DaggerSilver : WeaponBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Silver Dagger";
            SetLocalVariable("shop_listing", "Dagger, silver");
            Io.ItemData.Description = "A silver knife specifically designed for combat.";
            ...
            */
            ...
            Io.ItemData.Title = "Silver Dagger";
            Io.ItemData.SetObjectType(EquipmentGlobals.OBJECT_TYPE_DAGGER);
            Io.ItemData.Weight = 1f;
