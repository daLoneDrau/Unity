...
{
    public class Scimitar : WeaponBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Scimitar";
            SetLocalVariable("shop_listing", "Scimitar");
            Io.ItemData.Description = "A sword having a single-edged, curved blade.";
