...
{
    public class Javelin : WeaponBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Javelin";
            SetLocalVariable("shop_listing", "Javelin");
            Io.ItemData.Description = "A light spear designed to be thrown.";
