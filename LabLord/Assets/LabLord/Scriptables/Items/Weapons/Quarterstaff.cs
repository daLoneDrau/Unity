...
{
    public class Quarterstaff : WeaponBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Quarterstaff";
            SetLocalVariable("shop_listing", "Quarterstaff");
            Io.ItemData.Description = "A traditional non-bladed pole weapon.";
