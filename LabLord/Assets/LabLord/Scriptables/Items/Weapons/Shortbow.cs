...
{
    public class Shortbow : WeaponBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Shortbow";
            SetLocalVariable("shop_listing", "Shortbow");
            Io.ItemData.Description = "A ranged weapon system consisting of an elastic launching device and long-shafted projectiles.";
            ...
            */
            // 25gp
            Io.ItemData.Price = 2500f;

            Io.ItemData.StackSize = 1;
            Io.ItemData.Title = "Shortbow";
