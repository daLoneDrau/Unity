...
{
    public class PickLight : WeaponBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Light pick";
            SetLocalVariable("shop_listing", "Pick, light");
