...
{
    public class PickHeavy : WeaponBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Heavy pick";
            SetLocalVariable("shop_listing", "Pick, heavy");
            Io.ItemData.Description = "A type of war hammer that has a very long spike on the reverse of the hammer head.";
