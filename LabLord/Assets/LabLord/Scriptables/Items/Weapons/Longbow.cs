...
{
    public class Longbow : WeaponBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Longbow";
            SetLocalVariable("shop_listing", "Longbow");
            Io.ItemData.Description = "A type of bow that is tall – roughly equal to the height of the user.";
            ...
            */
            // 40gp
            Io.ItemData.Price = 4000f;

            Io.ItemData.StackSize = 1;
            Io.ItemData.Title = "Longbow";
