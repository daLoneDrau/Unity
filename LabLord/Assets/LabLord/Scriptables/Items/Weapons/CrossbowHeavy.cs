...
{
    public class CrossbowHeavy : WeaponBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Heavy Crossbow";
            SetLocalVariable("shop_listing", "Crossbow, heavy");
            Io.ItemData.Description = "A type of elastic ranged weapon.";
