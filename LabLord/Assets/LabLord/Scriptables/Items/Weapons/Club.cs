...
namespace LabLord.Scriptables.Items.Weapons
{
    public class Club : WeaponBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Club";
            SetLocalVariable("shop_listing", "Club");
            Io.ItemData.Description = "A blunt-force weapon.";
