...
{
    public class CrossbowLight : WeaponBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Light Crossbow";
            SetLocalVariable("shop_listing", "Crossbow, light");
            ...
            */
            // 3gp
            Io.ItemData.Price = 1600f;

            Io.ItemData.StackSize = 1;
            Io.ItemData.Title = "Light Crossbow";
