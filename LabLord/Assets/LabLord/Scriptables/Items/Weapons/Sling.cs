...
namespace LabLord.Scriptables.Items.Weapons
{
    public class Sling : WeaponBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Sling";
            SetLocalVariable("shop_listing", "Sling");
            Io.ItemData.Description = "A device used to hurl projectiles.";
