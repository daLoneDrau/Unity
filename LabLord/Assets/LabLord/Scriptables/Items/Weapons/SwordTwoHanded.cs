...
{
    public class SwordTwoHanded : WeaponBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Two-handed sword";
            SetLocalVariable("shop_listing", "Sword, two-handed");
            Io.ItemData.Description = "A large sword designed to be used with both hands.";
            ...
            */
            // 15gp
            Io.ItemData.Price = 1500f;

            Io.ItemData.StackSize = 1;
            Io.ItemData.Title = "Two-handed sword";
