...
{
    public class AxeHand : WeaponBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Hand Axe";
            SetLocalVariable("shop_listing", "Axe, hand");
            Io.ItemData.Description = "A single-handed striking tool.";
