...
namespace LabLord.Scriptables.Items.Weapons
{
    public class Spear : WeaponBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Spear";
            SetLocalVariable("shop_listing", "Spear");
            Io.ItemData.Description = "A pole weapon consisting of a shaft with a pointed head.";
