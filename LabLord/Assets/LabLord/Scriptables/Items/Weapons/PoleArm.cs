...
{
    public class PoleArm : WeaponBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Pole Arm";
            SetLocalVariable("shop_listing", "Pole Arm");
            Io.ItemData.Description = "A close combat weapon in which the main fighting part of the weapon is fitted to the end of a long shaft.";
            ...
            */
            // 7gp
            Io.ItemData.Price = 700f;

            Io.ItemData.StackSize = 1;
            Io.ItemData.Title = "Pole Arm";
            Io.ItemData.SetObjectType(EquipmentGlobals.OBJECT_TYPE_2H);
            Io.ItemData.Weight = 15f;
            
            Script.Instance.AddToGroup(Io, "ARMORY");
            Script.Instance.AddToGroup(Io, "BLADE");
            // Damage is 1D8
            SetLocalVariable("DMG", new int[] { 1, 10 });
