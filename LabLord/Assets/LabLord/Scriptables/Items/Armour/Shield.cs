...
{
    public class Shield : ArmourBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Shield";
            Io.ItemData.Title = "Shield";
            SetLocalVariable("shop_listing", "Shield");
            Io.ItemData.Price = 1000f;
            Io.ItemData.Weight = 10f;
            Io.ItemData.Equipitem.GetElementModifier(LabLordGlobals.EQUIP_ELEMENT_AC).Value = -1f;
            Io.ItemData.SetObjectType(EquipmentGlobals.OBJECT_TYPE_SHIELD);
            Script.Instance.AddToGroup(Io, "ARMORY");

            Io.ItemData.Description = "A piece of personal armour held in the hand or mounted on the wrist or forearm.";
            // apply modifiers
            /*
