...
{
    public class Helmet : ArmourBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Helmet";
            Io.ItemData.Title = "Helmet";
            SetLocalVariable("shop_listing", "Helmet");
            Io.ItemData.Price = 1000f;
            Io.ItemData.Weight = 5f;
            Io.ItemData.Equipitem.GetElementModifier(LabLordGlobals.EQUIP_ELEMENT_AC).Value = 0f;
            Io.ItemData.SetObjectType(EquipmentGlobals.OBJECT_TYPE_HELMET);
