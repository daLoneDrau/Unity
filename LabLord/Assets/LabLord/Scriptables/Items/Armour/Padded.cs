...
{
    public class Padded : ArmourBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Padded";
            Io.ItemData.Title = "Padded";
            SetLocalVariable("shop_listing", "Padded");
            Io.ItemData.Price = 400f;
            ...
            Io.ItemData.Description = "A padded defensive jacket.";
            // apply modifiers
            /*
