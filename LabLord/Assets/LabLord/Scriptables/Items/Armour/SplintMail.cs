...
{
    public class SplintMail : ArmourBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Splint mail";
            Io.ItemData.Title = "Splint mail";
            SetLocalVariable("shop_listing", "Splint mail");
            Io.ItemData.Price = 7500f;
            Io.ItemData.Weight = 45f;
            ...
            Io.ItemData.Description = "A type of mail with embedded plates.";
            // apply modifiers
            /*
