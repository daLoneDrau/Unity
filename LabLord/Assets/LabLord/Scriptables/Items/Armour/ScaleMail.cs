...
namespace LabLord.Scriptables.Items.Armour
{
    public class ScaleMail : ArmourBase
    {
        ...
        {
            // play sound file "equip_armor_chain"
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Scale mail";
            Io.ItemData.Title = "Scale mail";
            SetLocalVariable("shop_listing", "Scale mail");
            Io.ItemData.Price = 5000f;
            Io.ItemData.Weight = 40f;
            Io.ItemData.Equipitem.GetElementModifier(LabLordGlobals.EQUIP_ELEMENT_AC).Value = -3f;
            Io.ItemData.SetObjectType(EquipmentGlobals.OBJECT_TYPE_ARMOR);
            Script.Instance.AddToGroup(Io, "ARMORY");

            Io.ItemData.Description = "A form of armour consisting of many individual small armour scales of various shapes attached to each other.";
            // apply modifiers
            /*
