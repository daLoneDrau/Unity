...
{
    public class Leather : ArmourBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Leather";
            Io.ItemData.Title = "Leather";
            SetLocalVariable("shop_listing", "Leather");
            Io.ItemData.Price = 600f;
            Io.ItemData.Weight = 15f;
            ...
            Io.ItemData.Description = "Armour made out of various animals.";
            // apply modifiers
            /*
