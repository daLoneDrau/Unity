...
{
    public class BandedMail : ArmourBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Banded mail";
            Io.ItemData.Title = "Banded mail";
            SetLocalVariable("shop_listing", "Banded mail");
            Io.ItemData.Price = 8500f;
            Io.ItemData.Weight = 35f;
            Io.ItemData.Equipitem.GetElementModifier(LabLordGlobals.EQUIP_ELEMENT_AC).Value = -5f;
            Io.ItemData.SetObjectType(EquipmentGlobals.OBJECT_TYPE_ARMOR);
            Script.Instance.AddToGroup(Io, "ARMORY");

            Io.ItemData.Description = "A form of mail reinforced with bands of leather.";
            // apply modifiers
            /*
