...
{
    public class StuddedLeather : ArmourBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Studded leather";
            Io.ItemData.Title = "Studded leather";
            SetLocalVariable("shop_listing", "Studded leather");
            Io.ItemData.Price = 3000f;
            Io.ItemData.Weight = 20f;
            Io.ItemData.Equipitem.GetElementModifier(LabLordGlobals.EQUIP_ELEMENT_AC).Value = -2f;
            Io.ItemData.SetObjectType(EquipmentGlobals.OBJECT_TYPE_ARMOR);
            Script.Instance.AddToGroup(Io, "ARMORY");

            Io.ItemData.Description = "A leather armour studded with iron plates.";
            // apply modifiers
            /*
