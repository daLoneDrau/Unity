...
{
    public class PlateMail : ArmourBase
    {
        ...
        {
            // set local variables
            Io.ItemData.ItemName = "Plate mail";
            Io.ItemData.Title = "Plate mail";
            SetLocalVariable("shop_listing", "Plate mail");
            Io.ItemData.Price = 45000f;
            Io.ItemData.Weight = 50f;
            Io.ItemData.Equipitem.GetElementModifier(LabLordGlobals.EQUIP_ELEMENT_AC).Value = -6f;
            Io.ItemData.SetObjectType(EquipmentGlobals.OBJECT_TYPE_ARMOR);
            Script.Instance.AddToGroup(Io, "ARMORY");

            Io.ItemData.Description = "A type of personal body armour made from iron or steel plates.";
            // apply modifiers
            /*
